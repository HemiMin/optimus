...
for i in range(4):
    ...
    NN.add('conv_2_{}_1'.format(i), ConvLayer(128, 128, 64, 3, nimg=batch_size))
...
for i in range(6):
    ...
    NN.add('conv_3_{}_1'.format(i), ConvLayer(256, 256, 32, 3, nimg=batch_size))
...
NN.add('conv_4_0_1', ConvLayer(512, 512, 16, 2, nimg=batch_size))
NN.add('res_4_0', EltwiseLayer(512, 16, 1, nimg=batch_size),
        prevs=('res_3_5', 'conv_4_0_1'))

for i in range(1,3):
    NN.add('conv_4_{}_0'.format(i), ConvLayer(512, 512, 16, 1, nimg=batch_size))
    NN.add('conv_4_{}_1'.format(i), ConvLayer(512, 512, 16, 3, nimg=batch_size))
